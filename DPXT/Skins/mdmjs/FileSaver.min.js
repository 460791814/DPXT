...
var saveAs = saveAs || function (e) {
        ...
        var t = e.document, n = function () {
            ...
            e.dispatchEvent(t)
        }, a = /constructor/i.test(e.HTMLElement), f = function (t) {
            (e.setImmediate || e.setTimeout)(function () {
                throw t
            }, 0)
        }, u = "application/octet-stream", s = 1e3 * 40, d = function (e) {
            var t = function () {
                if (typeof e === "string") {
                    n().revokeObjectURL(e)
                } else {
            ...
            var p = this, v = t.type, w = v === u, m, y = function () {
                ...
                if (w && a && e.FileReader) {
                    ...
                    r.onloadend = function () {
                        var t = r.result;
                        e.location.href = "data:attachment/file" + t.slice(t.search(/[,;]/));
                        p.readyState = p.DONE;
                        y()
                    };
                    r.readAsDataURL(t);
            ...
            h()
        }, v = p.prototype, w = function (e, t, n) {
